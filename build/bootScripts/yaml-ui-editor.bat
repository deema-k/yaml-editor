...
set JARPATH=%APP_HOME%\lib\yaml-ui-editor.jar

@rem Execute yaml-ui-editor
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %YAML_UI_EDITOR_OPTS%  -jar "%JARPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%YAML_UI_EDITOR_EXIT_CONSOLE%" exit 1
exit /b 1
